...
*/
/*
 * Eliminar un elemento del índice especificado de Java ArrayList Example
 * Este ejemplo de Java muestra cómo eliminar un elemento en el índice especificado 
 * del objeto java ArrayList usando el método remove.
 * */
...
public class RemoveElementFromArrayListExample {
    ...
    */
        /*
         * Para eliminar un elemento del índice especificado de ArrayList, use el método Object.remove (int index).
         * Devuelve el elemento que se eliminó de ArrayList.
        */
